...
include("auth.php");
include("db.php");
$user=$_SESSION['id_akun'];
$sql="SELECT * FROM akun where id_akun='$user'";
...
<head>
  ...
  <title>Sistem Recording Penjualan</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-mini"><b>SRP</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Sistem Recording Penjualan</b></span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p><?php echo $data['username']; ?></p>
           <span class="label label-primary pull-right"><?php echo $data['level']; ?></span>
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="index.php?page=kasir"><i class="fa fa-money"></i><span>Kasir</span></a></li>
        <li><a href="index.php?page=manajer"><i class="fa fa-suitcase"></i><span>Manajer</span></a></li>
        <li><a href="index.php?page=cabang"><i class="fa fa-sitemap"></i><span>Cabang</span></a></li>
        <li><a href="index.php?page=transaksi"><i class="fa fa-shopping-cart"></i><span>Transaksi</span></a></li>
         <li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019 <font style="color : #72AFD2;">Sistem Inventory Digital</font>.</strong> All rights
    reserved.
  </footer>
